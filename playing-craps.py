...
#Defining the face frequencey counters
frequency1 = 0
frequency2 = 0
frequency3 = 0
frequency4 = 0
...
for roll in range(6_000_000): # note underscore separators
    ...
    # increment appropriate face counter - frequency counters
    if face == 1:
        frequency1 += 1
    elif face == 2:
        frequency2 += 1
...
print ('Percent of Frequency of Rolling Craps:', craps/trials)
print ('Percent of Frequency of Rolling a Win:', win/trials)
